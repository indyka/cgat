          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				...
				<!-- BO : Theme_options -->
                <li <?php if($action == 'theme_options'){?>class="active "<?php } ?>  >
                    <a href="<?php echo url("/"); ?>/admin/theme_options"><i class="fa fa-users"></i>
                    Theme_options
                    </a>
                </li>
                <!--  EO : Theme_options -->
				...
				<!-- BO : Items -->
                <li <?php if($action == 'items'){?>class="active "<?php } ?>  >
                    <a href="<?php echo url("/"); ?>/admin/items"><i class="fa fa-users"></i>
                    Items
                    </a>
                </li>
                <!--  EO : Items -->
