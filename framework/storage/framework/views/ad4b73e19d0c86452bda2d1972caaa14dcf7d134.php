              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li <?php if($action == 'generator'){?>class="active "<?php } ?>>
                    <a href="<?php echo url("/")."/admin/generator";?>"><i class="fa fa-cogs"></i> Code Generator </a>
                  </li>

                  <li <?php if($action == 'dashboard'){?>class="active "<?php } ?>>
                    <a href="<?php echo url("/")."/admin/dashboard";?>"><i class="fa fa-file"></i> Dashboard </a>
                  </li>               
                
                </ul>

                <h3 style="margin-top:15px">GENERATED PAGES</h3>
                <ul class="nav side-menu">

				<!-- BO : Pages -->
                <li <?php if($action == 'pages'){?>class="active "<?php } ?>  >
                    <a href="<?php echo url("/"); ?>/admin/pages"><i class="fa fa-file"></i>
                    Pages
                    </a>
                </li>
                <!--  EO : Pages -->           
               ...
               <!--  @@@@@#####@@@@@ -->
                ...
                <h3 style="margin-top:15px">USER SETTINGS</h3>
                <ul class="nav side-menu">
                <!-- BO : Users -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo url('/'); ?>/images/img.jpg" alt=""><?php echo e(auth()->user()->name); ?>
