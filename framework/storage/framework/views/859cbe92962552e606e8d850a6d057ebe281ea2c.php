...
$redirect = url('/').'/admin/category?'.urlencode($_SERVER["QUERY_STRING"]);
...
<div class="right_col" role="main">
  <div class="row x_panel">
    ...
    <div class="pull-left">
      <a href="<?php echo url('/'); ?>/admin/category/add" class="btn btn-success">Add Category</a>
    </div>
    <br>
    <hr>
      ...
      <th><input onclick="toggle(this,'cbgroup1')" id="foo[]" name="foo[]" type="checkbox" value="" /></th>
       <th> Sr No. </th>
          <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?>
            <?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="category.name"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>
            <th>
            <a href="<?php echo $links["category.name_link"]; ?>" class="link_css"> Name <?php echo $symbol ?></a>
            </th>
			<th class="action-width">products</th>
          <th></th>
      </thead>
      <tbody>
      <?php $count=1;
          ...
          foreach($data as $value){
           ?>
          <tr id="hide<?php $value->cat_id; ?>" >
            
            <th>
            <input name='input' id='del' onclick="callme('show')"  type='checkbox' class='del' value='<?php echo $value->cat_id; ?>'/>
            </th>
            <th>
            ...
            <?php echo e($value->name); ?>
                ...
                <th class="action-width">
                           <a href="<?php echo url('/')?>/admin/products/cat_id/<?php echo $value->cat_id; ?>" title="View">
		   ...
		   <th>
           <a href="<?php echo url("/"); ?>/admin/category/view/<?php echo $value->cat_id?>" title="View">
            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>
           </a>
           <a href="<?php echo url("/"); ?>/admin/category/edit/<?php echo $value->cat_id; ?>" title="Edit">
            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>
           </a>
           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="$('#set_commondel_id').val('<?php echo $value->cat_id; ?>');">
...
<div class="modal fade" id="commonDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <form action="<?php echo url('/'); ?>/admin/category/delete" method="post">
  <div class="modal-dialog">
   ...
   Do you really want to delete?
    <input type="hidden" id="set_commondel_id" name="cat_id">
...
<script type="text/javascript">
   ...
   {var confrm = confirm("Are you sure you want to delete?");
     if(confrm)
     {
       ...
       $.ajax({
         type:"POST",
         url:'<?php echo url("/")."/admin/category/deleteAll"; ?>',
         data:{
          allIds:ids,
