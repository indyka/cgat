    ...
    <form method="GET" action="" class="form-inline ibox-content">
        <div class="form-group">
          <select name="searchBy" class="form-control">
           <option value="pages.user_id" <?php echo $searchBy=="pages.user_id"?'selected="selected"':""; ?>>User_id</option><option value="pages.theme_id" <?php echo $searchBy=="pages.theme_id"?'selected="selected"':""; ?>>Theme_id</option>
          </select>
        </div>
        <div class="form-group">
      ...
      <th><input onclick="toggle(this,'cbgroup1')" id="foo[]" name="foo[]" type="checkbox" value="" /></th>
       <th> Sr No. </th>
          <?php $sortSym=isset($_GET["order"]) && $_GET["order"]=="asc" ? "up" : "down"; ?>
            <?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="pages.user_id"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>
            <th>
            <a href="<?php echo $links["pages.user_id_link"]; ?>" class="link_css"> User Id <?php echo $symbol ?></a>
            </th>
			
            <?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="pages.theme_id"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>
            <th>
            <a href="<?php echo $links["pages.theme_id_link"]; ?>" class="link_css"> Theme Id <?php echo $symbol ?></a>
            </th>
          ...
          <tr id="hide<?php $value->id; ?>" >
            ...
            <?php echo e($value->theme_id); ?>
                ...
                <th class="action-width">
                           <a href="<?php echo url('/')?>/admin/items/description/<?php echo $value->id; ?>" title="View">
