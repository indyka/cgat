    ...
    <script type="text/javascript">
        ...
        function getField()
        {
            ...
            $.ajax({
                ...
                type: "post",
                data: "parent_table="+parent_table+"&tbl_name=" + tbl_name+"&_token="+"{{ csrf_token() }}",
                beforeSend: function () {
                },
                success: function (result) {
        ...
        function getFieldOneToMany()
        {
         ...
         function popuplate_multi_get_key_value(element, key, value, type='') {
          ...
          $.ajax({
                url: url_new,
                type: "post",
                data: "parent_table="+parent_table+"&multi_table="+multi_table+"&table="+table_name+"&_token="+"{{ csrf_token() }}",
                beforeSend: function () {
                },
                success: function (result) {
                    var arr = result.split("==##==");
