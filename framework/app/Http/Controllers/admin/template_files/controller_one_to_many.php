...
{   
    ...
    public function index(Request @@@request){
        ...
        return view('admin/==table==/index', ['data'=>@@@data->appends(Input::except('page')), 'per_page'=>@@@per_page, 'links'=>@@@links, 'rel_field'=>@@@rel_field, 'rel_id'=>@@@rel_id]);
    }
    ...
    public function postEdit(Request @@@request){
        ...
        if(@@@==table==->updatecontroller_name(@@@request)){
            ...
            return redirect()->action('admin\controller_nameController@index', [@@@rel_field, @@@rel_id]);
        } else{
