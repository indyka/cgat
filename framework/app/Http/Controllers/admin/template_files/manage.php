...
<div class="right_col" role="main">
  <div class="row x_panel">
    ...
    <div class="pull-left">
      <a href="<?php echo url('/'); ?>/admin/==table==/add" class="btn btn-success">Add ==big_table==</a>
    </div>
    <br>
    <hr>
    ...
    <form method="GET" action="" class="form-inline ibox-content">
        ...
        <input type="submit" name="search" value="Search" class="btn btn-info" style="margin-top:5px">
